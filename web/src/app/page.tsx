...
export default async function Home() {
  ...
  return (
    <>
      ...
      <div className="relative bg-primary-blue h-[calc(100vh-72px)] w-full flex items-center">
        <div className="max-w-360 mx-auto px-6 md:px-12 lg:px-20 w-full flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col gap-8 items-start max-w-200 py-16 lg:py-40">
            <h1 className="font-(family-name:--font-young-serif) text-5xl sm:text-7xl lg:text-[120px] text-[#e7a802] leading-none text-left">
              Brighton Pauper League
            </h1>
            <p className="font-(family-name:--font-bricolage-grotesque) font-medium text-2xl md:text-[32px] text-[#c3c2ea] leading-tight text-left">
          ...
          <div className="flex items-center justify-center w-full max-w-[320px] lg:max-w-[560px]">
            <Image
                src="/logo.webp"
      ...
      {/* Who We Are Section */}
      <section className="bg-[#c3c2ea] px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-[120px]">
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-10">
          {/* Left Column - Who is this for? */}
          <div className="w-full lg:w-[620px] flex flex-col gap-12">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#004aad] leading-tight">
              Who is this for?
            </h2>
          ...
          <div className="w-full lg:w-[620px] flex flex-col gap-8 justify-start">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#004aad] leading-tight mb-4">
              What is Pauper?
            </h2>
      ...
      <section className="bg-primary-blue px-6 md:px-12 lg:px-20 lg:min-h-screen flex items-center">
        <div className="max-w-360 mx-auto flex flex-col lg:flex-row gap-10 py-20 w-full">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              <div
                  className="bg-[#003a8a] border-2 border-[#e7a802] p-10 rounded-2xl hover:bg-[#004aad] hover:scale-[1.02] hover:shadow-xl transition-all duration-200 cursor-pointer">
                <div className="flex flex-col gap-2">
                  <span
                      className="bg-[#e7a802] px-3 py-1 rounded text-[#371e22] font-(family-name:--font-bricolage-grotesque) font-extrabold text-xs uppercase w-fit">
                    League Nights
                  </span>
              ...
              <div
                ...
                <div className="flex flex-col gap-2">
                  <span
                      className="bg-[#9fb299] px-3 py-1 rounded text-[#371e22] font-(family-name:--font-bricolage-grotesque) font-extrabold text-xs uppercase w-fit">
                    Casual Pauper
                  </span>
                  <h3 className="font-(family-name:--font-young-serif) text-2xl md:text-[32px] text-white">
                    Tuesdays
      ...
      <section className="bg-off-white px-6 md:px-12 lg:px-20 py-16 md:py-24">
        <div className="max-w-360 mx-auto flex flex-col gap-7">
          <div className="flex flex-col gap-4">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#371e22] leading-tight">
      ...
      <section className="bg-dark-brown px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-section-y">
        <div className="max-w-360 mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-12">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#e7a802] leading-tight">
              Our Values
            </h2>
        ...
        <div className="max-w-360 mx-auto flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
          ...
          <div className="flex-1 flex flex-col gap-12">
            <div className="max-w-200">
              <h2 className="font-(family-name:--font-young-serif) text-4xl md:text-5xl lg:text-[72px] text-[#371e22] leading-none mb-8">
                No deck? No problem.
              </h2>
      ...
      {/* Standings Section */}
      <section className="bg-[#fcfbfa] px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-[120px]">
        <div className="max-w-360 mx-auto flex flex-col lg:flex-row gap-10">
          {/* Left - Standings Table */}
          <div className="flex-1">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#371e22] leading-tight mb-4">
              Season Standings
            </h2>
      ...
      {/* Rules Section */}
      <section className="bg-[#004aad] px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-[120px]">
        <div className="max-w-360 mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
          {/* Code of Conduct */}
          <div className="flex flex-col gap-6">
            <h3 className="font-(family-name:--font-young-serif) text-2xl md:text-[32px] text-[#e7a802]">
              Code of Conduct
            </h3>
      ...
      {/* Media Section */}
      <section className="bg-[#371e22] px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-[120px]">
        <div className="max-w-360 mx-auto flex flex-col gap-12">
          <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-white leading-tight">
            Follow the League
          </h2>
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            {/* Left - Feature Video */}
            <div className="w-full lg:w-[760px] flex flex-col gap-4">
      ...
      <section className="bg-[#9fb299] px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-[120px]">
        <div className="max-w-360 mx-auto flex flex-col gap-12">
          <div className="max-w-200">
            <h2 className="font-(family-name:--font-young-serif) text-3xl md:text-4xl lg:text-[56px] text-[#371e22] leading-tight mb-6">
              Want to help?
            </h2>
            <p className="font-(family-name:--font-bricolage-grotesque) text-xl text-[#371e22]/80 leading-relaxed">
